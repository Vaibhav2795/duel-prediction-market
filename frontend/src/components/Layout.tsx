				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex flex-col md:flex-row items-center justify-between gap-4">
						<div className="flex items-center gap-2">
							...
							<span className="text-sm text-text-secondary">ChessBet Prediction Market</span>
						</div>
						<div className="flex items-center gap-6 text-sm text-text-tertiary">
							...
							<button className="hover:text-text-secondary transition-colors">Discord</button>
							<button className="hover:text-text-secondary transition-colors">Twitter</button>
						</div>
					</div>
				</div>
			</footer>
